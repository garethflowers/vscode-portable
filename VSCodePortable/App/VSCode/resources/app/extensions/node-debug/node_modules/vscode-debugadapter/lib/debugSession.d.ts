...
export declare class Breakpoint implements DebugProtocol.Breakpoint {
    verified: boolean;
    line: number;
    constructor(verified: boolean, line: number, column?: number);
}
...
export declare class DebugSession extends ProtocolServer {
    ...
    shutdown(): void;
    protected sendErrorResponse(response: DebugProtocol.Response, code: number, format: string, args?: any, dest?: ErrorDestination): void;
